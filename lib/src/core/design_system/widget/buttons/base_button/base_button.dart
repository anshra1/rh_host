  ...
  Widget build(BuildContext context) {
    ...
    switch (variant) {
      case ButtonVariant.primary:
        bgColor = backgroundColor ?? AppColors.primaryColorColor;
      ...
      case ButtonVariant.outline:
        ...
        textColor = AppColors.primaryColorColor;
        borderSide = const BorderSide(color: AppColors.primaryColorColor);
    ...
    final defaultTextStyle = context.titleMedium.copyWith(
      color: textColor,
