...
//         EnableDisablePasscode(passcodeRepo: mockPasscodeRepo);
//     setNewPasscode = SetNewPasscode(passcodeRepo: mockPasscodeRepo);
//     shouldShowPasscode =
//         ShouldShowPasscodeUseCase(passcodeRepo: mockPasscodeRepo);
...
//     test('should return Left(ServerFailure) when enableDisablePasscode fails',
//         () async {
//       when(() => mockPasscodeRepo.enableDisablePasscode())
...
//     test(
//         'should call setNewPasscode from the repository with correct parameters',
//         () async {
//       when(
...
//     test('should return Left(ServerFailure) when setNewPasscode fails',
//         () async {
//       when(
//         () => mockPasscodeRepo.setNewPasscode(
//           newPasscode: any(named: 'newPasscode'),
...
//     test('should return Left(ServerFailure) when shouldShowPasscode fails',
//         () async {
//       when(() => mockPasscodeRepo.shouldShowPasscode())
//           .thenAnswer((_) async => const Left(tServerFailure));
...
//     test(
//         'should call verifyPasscode from the repository with correct parameter',
//         () async {
...
//     test('should return Left(ServerFailure) when verifyPasscode fails',
//         () async {
//       when(() => mockPasscodeRepo.verifyPasscode(any()))
//           .thenAnswer((_) async => const Left(tServerFailure));
